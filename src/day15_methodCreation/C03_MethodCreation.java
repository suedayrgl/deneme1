...
public class C03_MethodCreation {
    public static void main(String[] args) {
        ...
        // eger kelime 3 4 veya 5 harfli ise harf saysini ve
    ...
    private static void ucHarfiTersineCevir(String kelime) {
       String tersKelime=kelime.substring(2)+
                kelime.substring(1,2)+
                kelime.substring(0,1);
        System.out.println("girdigiiniz kelimedeki harf sayisi : 3" );
        System.out.println("kelimenin tersten yazilisi : "+tersKelime);


    }
    // 1- method olusturmak icin method un adini yazariz
    // 2- method a giderken goturmem gereken variable varsa bunu methoda eklemeliyim 
